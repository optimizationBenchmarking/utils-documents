...
public enum BibliographyXML implements IXMLFileType {
  ...
  static {
    ...
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.BACHELOR_THESIS
        .ordinal()] = "bachelor";//$NON-NLS-1$ 1$
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.MASTER_THESIS
        .ordinal()] = "master";//$NON-NLS-1$ 1$
    BibliographyXML.VAL_THESIS_TYPES[EThesisType.PHD_THESIS
