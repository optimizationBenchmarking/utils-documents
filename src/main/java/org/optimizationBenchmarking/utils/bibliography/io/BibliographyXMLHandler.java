...
public final class BibliographyXMLHandler extends DelegatingHandler {
  ...
  protected final void doStartElement(final String uri,
    ...
    if ((uri == null)
        || (BibliographyXML.NAMESPACE.equalsIgnoreCase(uri))) {

      if (BibliographyXML.ELEMENT_BIBLIOGRAPHY
      ...
      if (BibliographyXML.ELEMENT_ARTICLE.equalsIgnoreCase(localName)) {
        ...
        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            ...
            BibliographyXML.ATTR_JOURNAL)) != null) {
          bab.setJournal(s);
        }

        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_NUMBER)) != null) {
          bab.setNumber(s);
        }

        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_VOLUME)) != null) {
          bab.setVolume(s);
        }

        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_START_PAGE)) != null) {
          bab.setStartPage(s);
        }

        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_END_PAGE)) != null) {
          bab.setEndPage(s);
        }

        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_ISSN)) != null) {
          bab.setISSN(s);
        }
      ...
      if (BibliographyXML.ELEMENT_PROCEEDINGS
          .equalsIgnoreCase(localName)) {
        if (bfsm instanceof BibliographyBuilder) {
      ...
      if (BibliographyXML.ELEMENT_THESIS.equalsIgnoreCase(localName)) {
        ...
        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_THESIS_TYPE)) != null) {
      ...
      if (BibliographyXML.ELEMENT_TECH_REPORT
          .equalsIgnoreCase(localName)) {
        this.m_builders.add(//
        ...
        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
            BibliographyXML.ATTR_SERIES)) != null) {
          btrb.setSeries(s);
        }
        if ((s = DelegatingHandler.getAttributeNormalized(attributes,
            BibliographyXML.NAMESPACE,
      ...
      if (BibliographyXML.ELEMENT_START_DATE.equalsIgnoreCase(localName)) {
        this.m_builders
            .add(bdb = ((BibProceedingsBuilder) bfsm).startDate());
        BibliographyXMLHandler.__setDateAtts(bdb, attributes);
        return;
      }
      ...
      if (BibliographyXML.ELEMENT_PUBLISHER.equalsIgnoreCase(localName)) {
        this.m_builders
            .add(bob = ((BibRecordWithPublisherBuilder) bfsm).publisher());
      ...
      if (BibliographyXML.ELEMENT_LOCATION.equalsIgnoreCase(localName)) {
        this.m_builders
            .add(bob = ((BibProceedingsBuilder) bfsm).location());
        BibliographyXMLHandler.__setPlaceAtts(bob, attributes);
        return;
      }
      ...
      if (BibliographyXML.ELEMENT_INSTITUTION
          .equalsIgnoreCase(localName)) {
        this.m_builders
            .add(bob = ((BibTechReportBuilder) bfsm).publisher());
        BibliographyXMLHandler.__setPlaceAtts(bob, attributes);
        return;
      }
    }
  ...
  private static final void __setPlaceAtts(
    ...
    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_ADDRESS)) != null) {
      rec.setAddress(s);
    }

    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_ORGANIZATION)) != null) {
      rec.setName(s);
    }
  ...
  private static final void __setAuthorAtts(final BibAuthorBuilder rec,
    ...
    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_FAMILY_NAME)) != null) {
      rec.setFamilyName(s);
    }

    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_PERSONAL_NAME)) != null) {
  ...
  private static final void __setInBookAtts(final BibInBookBuilder rec,
    ...
    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_CHAPTER)) != null) {
      rec.setChapter(s);
    }
  }
  ...
  private static final void __setDateAtts(final BibDateBuilder rec,
    ...
    if ((s = DelegatingHandler.getAttributeNormalized(atts,
      ...
      if ((s = DelegatingHandler.getAttributeNormalized(atts,
          BibliographyXML.NAMESPACE,
          BibliographyXML.ATTR_QUARTER)) != null) {
  ...
  private static final void __setBookAtts(final BibBookRecordBuilder rec,
    ...
    if ((s = DelegatingHandler.getAttributeNormalized(atts,
        BibliographyXML.NAMESPACE,
        BibliographyXML.ATTR_EDITION)) != null) {
      rec.setEdition(s);
    }
    ...
    if ((uri == null)
      ...
      if (BibliographyXML.ELEMENT_BIBLIOGRAPHY
        ...
        if (BibliographyXML.ELEMENT_ARTICLE.equalsIgnoreCase(localName) || //
            ...
            BibliographyXML.ELEMENT_PROCEEDINGS.equalsIgnoreCase(localName)
            || //
            BibliographyXML.ELEMENT_THESIS.equalsIgnoreCase(localName) || //
            BibliographyXML.ELEMENT_WEBSITE.equalsIgnoreCase(localName) || //
            BibliographyXML.ELEMENT_TECH_REPORT.equalsIgnoreCase(localName)
            || //
