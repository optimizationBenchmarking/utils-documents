...
public enum DocumentXML implements IXMLFileType {
  ...
  static {
    ...
    DocumentXML.VAL_TEXT_CASE[ETextCase.AT_SENTENCE_START
        .ordinal()] = "atSentenceStart";//$NON-NLS-1$
    DocumentXML.VAL_TEXT_CASE[ETextCase.IN_SENTENCE
        .ordinal()] = "inSentence";//$NON-NLS-1$
    DocumentXML.VAL_TEXT_CASE[ETextCase.AT_TITLE_START
        .ordinal()] = "atTitleStart";//$NON-NLS-1$
  ...
  static {
    ...
    DocumentXML.VAL_SEQUENCE_MODE[ESequenceMode.EITHER_OR
        .ordinal()] = "eitherOr";//$NON-NLS-1$
    DocumentXML.VAL_SEQUENCE_MODE[ESequenceMode.NEITHER_NOR
        .ordinal()] = "neitherNor";//$NON-NLS-1$
    DocumentXML.VAL_SEQUENCE_MODE[ESequenceMode.FROM_TO
  ...
  static {
    ...
    DocumentXML.VAL_CITATION_MODE[ECitationMode.AUTHORS_AND_ID
        .ordinal()] = "authorsAndID";//$NON-NLS-1$
    DocumentXML.VAL_CITATION_MODE[ECitationMode.AUTHORS_AND_YEAR
        .ordinal()] = "authorsAndYear";//$NON-NLS-1$
    DocumentXML.VAL_CITATION_MODE[ECitationMode.AUTHORS
  ...
  static {
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.VERY_MUCH_LESS
        .ordinal()] = "lll"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.LESS_OR_EQUAL
        .ordinal()] = "le"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.GREATER_OR_EQUAL
        .ordinal()] = "ge"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.VERY_MUCH_GREATER
        .ordinal()] = "ggg"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.EQUAL.ordinal()] = "e"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.EQUIVALENT
        .ordinal()] = "equiv"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.APPROXIMATELY
        .ordinal()] = "approx"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.APPROXIMATELY_EQUAL
        .ordinal()] = "approxe"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.PROPROTIONAL_TO
        .ordinal()] = "prop"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_EQUAL.ordinal()] = "ne"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_EQUIVALENT
        .ordinal()] = "nequiv"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_APPROXIMATELY
        .ordinal()] = "napprox"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_ELEMENT_OF
        .ordinal()] = "nin"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.SUBSET_OF
        .ordinal()] = "subset"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_SUBSET_OF
        .ordinal()] = "nsubset"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.SUBSET_OF_OR_EQUAL
        .ordinal()] = "subsete"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.APPROXIMATED_AS
        .ordinal()] = "estim"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.PRECEDES.ordinal()] = "pred"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_PRECEDES
        .ordinal()] = "npred"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.PRECEDES_OR_EQUAL
        .ordinal()] = "prede"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_SUCCEEDS
        .ordinal()] = "nsucc"; //$NON-NLS-1$
    DocumentXML.VAL_COMP_OP[EMathComparison.SUCCEEDS_OR_EQUAL
        .ordinal()] = "succe"; //$NON-NLS-1$
    ...
    DocumentXML.VAL_COMP_OP[EMathComparison.NOT_SIMILAR
        .ordinal()] = "nsim"; //$NON-NLS-1$
   ...
   */
  static final EMathComparison _parseComparisonOperator(
      final String string) {
    int i;
  ...
  public final URL getSchemaSource() throws IOException {
    ...
    u = this.getClass().getResource(//
        DocumentXML.NAMESPACE
            .substring(DocumentXML.NAMESPACE.lastIndexOf('/') + 1));
    if (u != null) {
      return u;
    }
