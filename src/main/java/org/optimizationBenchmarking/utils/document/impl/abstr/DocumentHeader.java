 ...
 */
public class DocumentHeader extends DocumentPart
    implements IDocumentHeader {

  /** an title has been created */
  private static final int STATE_TITLE_CREATED = (DocumentElement.STATE_MAX_ELEMENT
      + 1);
  /** a title is about to be opened */
  private static final int STATE_TITLE_BEFORE_OPEN = (DocumentHeader.STATE_TITLE_CREATED
      + 1);
  /** a title has been opened */
  private static final int STATE_TITLE_AFTER_OPEN = (DocumentHeader.STATE_TITLE_BEFORE_OPEN
      + 1);
  /** a title has been closed */
  private static final int STATE_TITLE_CLOSED = (DocumentHeader.STATE_TITLE_AFTER_OPEN
      + 1);

  /** an authors builder has been created */
  private static final int STATE_AUTHORS_BUILDER_CREATED = (DocumentHeader.STATE_TITLE_CLOSED
      + 1);
  /** an authors builder is about to be opened */
  private static final int STATE_AUTHORS_BUILDER_BEFORE_OPEN = (DocumentHeader.STATE_AUTHORS_BUILDER_CREATED
      + 1);
  /** an authors builder has been opened */
  private static final int STATE_AUTHORS_BUILDER_AFTER_OPEN = (DocumentHeader.STATE_AUTHORS_BUILDER_BEFORE_OPEN
      + 1);
  /** an authors builder has been closed */
  private static final int STATE_AUTHORS_BUILDER_CLOSED = (DocumentHeader.STATE_AUTHORS_BUILDER_AFTER_OPEN
      + 1);
  /** we are after the authors */
  private static final int STATE_AUTHORS_AFTER = (DocumentHeader.STATE_AUTHORS_BUILDER_CLOSED
      + 1);

  /** an date builder has been created */
  private static final int STATE_DATE_BUILDER_CREATED = (DocumentHeader.STATE_AUTHORS_AFTER
      + 1);
  /** an date builder is about to be opened */
  private static final int STATE_DATE_BUILDER_BEFORE_OPEN = (DocumentHeader.STATE_DATE_BUILDER_CREATED
      + 1);
  /** an date builder has been opened */
  private static final int STATE_DATE_BUILDER_AFTER_OPEN = (DocumentHeader.STATE_DATE_BUILDER_BEFORE_OPEN
      + 1);
  /** an date builder has been closed */
  private static final int STATE_DATE_BUILDER_CLOSED = (DocumentHeader.STATE_DATE_BUILDER_AFTER_OPEN
      + 1);
  /** we are after the date */
  private static final int STATE_DATE_AFTER = (DocumentHeader.STATE_DATE_BUILDER_CLOSED
      + 1);

  /** an summary has been created */
  private static final int STATE_SUMMARY_CREATED = (DocumentHeader.STATE_DATE_AFTER
      + 1);
  /** a summary is about to be opened */
  private static final int STATE_SUMMARY_BEFORE_OPEN = (DocumentHeader.STATE_SUMMARY_CREATED
      + 1);
  /** a summary has been opened */
  private static final int STATE_SUMMARY_AFTER_OPEN = (DocumentHeader.STATE_SUMMARY_BEFORE_OPEN
      + 1);
  /** a summary has been closed */
  private static final int STATE_SUMMARY_CLOSED = (DocumentHeader.STATE_SUMMARY_AFTER_OPEN
      + 1);

  /** the header has been finalized */
  private static final int STATE_HEADER_FINALIZED = (DocumentHeader.STATE_SUMMARY_CLOSED
      + 1);
