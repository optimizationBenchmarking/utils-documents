...
final class _XHTML10TableBodyCell extends TableBodyCell {
  ...
  /** the class c */
  private static final char[] TAB_CLASS_C = { ' ', 'c', 'l', 'a', 's', 's',
      '=', '"', 't', 'a', 'b', 'C', '"', };
  /** the class l */
  private static final char[] TAB_CLASS_L = { ' ', 'c', 'l', 'a', 's', 's',
      '=', '"', 't', 'a', 'b', 'L', '"', };
  /** the class r */
  private static final char[] TAB_CLASS_R = { ' ', 'c', 'l', 'a', 's', 's',
      '=', '"', 't', 'a', 'b', 'R', '"', };
  /** the class colspan */
  private static final char[] TAB_CS = { ' ', 'c', 'o', 'l', 's', 'p', 'a',
      'n', '=', '"', };
  /** the class rowspan */
  private static final char[] TAB_RS = { ' ', 'r', 'o', 'w', 's', 'p', 'a',
      'n', '=', '"', };
   ...
   *          the cell
   */
  static final void _cellMode(final ITextOutput out,
