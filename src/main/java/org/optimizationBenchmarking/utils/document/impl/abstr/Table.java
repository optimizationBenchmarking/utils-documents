 ...
 */
public class Table extends ComplexObject
    implements ITable, Iterable<ETableCellDef> {
  ...
  private static final int STATE_CAPTION_BEFORE_OPEN = (Table.STATE_CAPTION_CREATED
      + 1);
  /** the state in the caption */
  private static final int STATE_CAPTION_OPENED = (Table.STATE_CAPTION_BEFORE_OPEN
      + 1);
  /** the state after the caption */
  private static final int STATE_CAPTION_CLOSED = (Table.STATE_CAPTION_OPENED
      + 1);

  /** the state when the header has been created */
  private static final int STATE_HEADER_CREATED = (Table.STATE_CAPTION_CLOSED
      + 1);
  /** the state before the header */
  private static final int STATE_HEADER_BEFORE_OPEN = (Table.STATE_HEADER_CREATED
      + 1);
  /** the state in the header */
  private static final int STATE_HEADER_OPENED = (Table.STATE_HEADER_BEFORE_OPEN
      + 1);
  /** the state after the header */
  private static final int STATE_HEADER_CLOSED = (Table.STATE_HEADER_OPENED
      + 1);
  /** the state when the body has been created */
  private static final int STATE_BODY_CREATED = (Table.STATE_HEADER_CLOSED
      + 1);
  /** the state before the body */
  private static final int STATE_BODY_BEFORE_OPEN = (Table.STATE_BODY_CREATED
      + 1);
  /** the state in the body */
  private static final int STATE_BODY_OPENED = (Table.STATE_BODY_BEFORE_OPEN
      + 1);
  /** the state after the body */
  private static final int STATE_BODY_CLOSED = (Table.STATE_BODY_OPENED
      + 1);
  /** the state when the footer has been created */
  private static final int STATE_FOOTER_CREATED = (Table.STATE_BODY_CLOSED
      + 1);
  /** the state before the footer */
  private static final int STATE_FOOTER_BEFORE_OPEN = (Table.STATE_FOOTER_CREATED
      + 1);
  /** the state in the footer */
  private static final int STATE_FOOTER_OPENED = (Table.STATE_FOOTER_BEFORE_OPEN
      + 1);
  /** the state after the footer */
  private static final int STATE_FOOTER_CLOSED = (Table.STATE_FOOTER_OPENED
      + 1);
