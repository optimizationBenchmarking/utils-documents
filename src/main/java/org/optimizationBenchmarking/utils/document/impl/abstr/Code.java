...
public class Code extends ComplexObject implements ICode {
  ...
  private static final int STATE_CAPTION_BEFORE_OPEN = (Code.STATE_CAPTION_CREATED
      + 1);
  /** the state in the caption */
  private static final int STATE_CAPTION_OPENED = (Code.STATE_CAPTION_BEFORE_OPEN
      + 1);
  /** the state after the caption */
  private static final int STATE_CAPTION_CLOSED = (Code.STATE_CAPTION_OPENED
      + 1);

  /** the state when the body has been created */
  private static final int STATE_BODY_CREATED = (Code.STATE_CAPTION_CLOSED
      + 1);
  /** the state before the body */
  private static final int STATE_BODY_BEFORE_OPEN = (Code.STATE_BODY_CREATED
      + 1);
  /** the state in the body */
  private static final int STATE_BODY_OPENED = (Code.STATE_BODY_BEFORE_OPEN
      + 1);
  /** the state after the body */
  private static final int STATE_BODY_CLOSED = (Code.STATE_BODY_OPENED
      + 1);
