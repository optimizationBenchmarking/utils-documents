...
public class XHTML10ConfigurationBuilder
  ...
  static final PageDimension _pageDimension(final PhysicalDimension size) {
    ...
    return new PageDimension(
        XHTML10ConfigurationBuilder.__trim(size.getWidth()), //
  ...
  public final void setScreenSize(final EScreenSize size) {
    ...
    this.m_size = XHTML10ConfigurationBuilder
        ._pageDimension(size.getPageSize());
  }
   ...
   */
  public final void setFontPalette(final IFontPalette fonts) {
  ...
  public boolean equals(final Object o) {
    ...
    if (o instanceof XHTML10Configuration) {
      if (super.equals(o)) {
        ...
        return (Compare.equals(this.m_fonts, config.getFontPalette())//
            && Compare.equals(this.m_size, config.getScreenSize()));
      }
    } else {
      if (o instanceof XHTML10ConfigurationBuilder) {
        if (super.equals(o)) {
          builder = ((XHTML10ConfigurationBuilder) o);
          return (Compare.equals(this.m_fonts, builder.m_fonts)//
              && Compare.equals(this.m_size, builder.m_size));
        }
      }
    }
