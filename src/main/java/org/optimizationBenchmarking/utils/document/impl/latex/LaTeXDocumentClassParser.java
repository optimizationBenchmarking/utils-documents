...
public final class LaTeXDocumentClassParser
    extends InstanceParser<LaTeXDocumentClass> {
  ...
  private static final String[] __prefixes() {
    ...
    ReflectionUtils.addPackageOfClassToPrefixList(LaTeXDocumentClass.class,
        paths);
