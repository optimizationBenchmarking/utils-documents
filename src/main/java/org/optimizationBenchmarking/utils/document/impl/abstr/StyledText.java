...
public class StyledText extends ComplexText {
   ...
   *          the text output
   */
  protected void beginColor(final ColorStyle color,
   ...
   *          the text output
   */
  protected void beginWhite(final ColorStyle color,
      final ITextOutput out) {
   ...
   *          the text output
   */
  protected void beginBlack(final ColorStyle color,
      final ITextOutput out) {
    //
  }
   ...
   *          the text output
   */
  protected void endNormalText(final FontStyle font,
      final ITextOutput out) {
    //
  }
   ...
   *          exception?
   */
  static final void _forbid(final IStyle style,
      final boolean throwIllegal) {
    MemoryTextOutput o;
    String s;
