...
public final class LaTeXDriver extends DocumentDriver {
  ...
  /** the caption */
  static final char[] CAPTION_BEGIN = { '\\', 'c', 'a', 'p', 't', 'i', 'o',
      'n', '{' };
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXInlineCode createInlineCode(
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXInlineMath createInlineMath(
      final ComplexText owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXSectionTitle createSectionTitle(
      final Section owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXSectionBody createSectionBody(
      final Section owner) {
  ...
  protected final _LaTeXEquation createEquation(final SectionBody owner,
      final ILabel useLabel, final int index) {
    return new _LaTeXEquation(((_LaTeXSectionBody) owner), useLabel,
        index);
  }
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXMathNegate createMathNegate(
      final BasicMath owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXSubFigure createSubFigure(final FigureSeries owner,
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXMathNumber createMathNumber(
      final BasicMath owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXTableCaption createTableCaption(
      final Table owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _LaTeXEmphasize createEmphasize(
      final ComplexText owner) {
  ...
  protected final void cite(final Bibliography bib,
    ...
    if ((bib.size() == 1) || ((sequenceMode == ESequenceMode.COMMA)
        && (citationMode == ECitationMode.ID))) {
  ...
  private static final class __LaTeXDefaultGraphicDriverLoader {
    ...
    static {
      final ArraySetView<EGraphicFormat> supported;
      IGraphicDriver driver;
      ArrayList<Throwable> error;

      error = null;
      driver = null;
      supported = LaTeX.getAllSupportedGraphicFormats();
