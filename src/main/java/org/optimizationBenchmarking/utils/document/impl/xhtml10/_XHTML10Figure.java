...
final class _XHTML10Figure extends Figure {
  ...
  private static final char[] FIGURE_IMG_WIDTH = { '"', ' ', 's', 't', 'y',
      'l', 'e', '=', '"', 'w', 'i', 'd', 't', 'h', ':', };
  ...
  protected final void onFigureClose(final PhysicalDimension size,
    ...
    _XHTML10Figure._img(out, files.get(0).getKey(),
        this.getDocument().getDocumentFolder(), size, this.m_caption);
