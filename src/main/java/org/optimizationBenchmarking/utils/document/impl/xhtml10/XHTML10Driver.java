...
public final class XHTML10Driver extends DocumentDriver {
  ...
  /** the head line start */
  static final char[][] HEADLINE_BEGIN = { { '<', 'h', '1', '>' },
      { '<', 'h', '2', '>' }, { '<', 'h', '3', '>' },
      { '<', 'h', '4', '>' }, { '<', 'h', '5', '>' },
      { '<', 'h', '6', '>' }, { '<', 'd', 'i', 'v', ' ', 'c', 'l', 'a',
          's', 's', '=', '"', 'h', '7', '"', '>' } };
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10Emphasize createEmphasize(
      final ComplexText owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10SectionBody createSectionBody(
      final Section owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10MathNegate createMathNegate(
      final BasicMath owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10MathAbs createMathAbsolute(
      final BasicMath owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10MathNumber createMathNumber(
      final BasicMath owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10TableCaption createTableCaption(
      final Table owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10TableHeader createTableHeader(
      final Table owner) {
  ...
  /** {@inheritDoc} */
  @Override
  protected final _XHTML10TableFooter createTableFooter(
      final Table owner) {
  ...
  protected void checkGraphicDriver(final IGraphicDriver driver) {
    ...
    if (format instanceof EGraphicFormat) {
      switch ((EGraphicFormat) format) {
        case SVG:
        case JPEG:
        case PNG:
        case GIF:
    ...
    throw new IllegalArgumentException(//
        "XHTML 1.0 driver only supports PNG, GIF, JPEG, SVG, and BMP graphic formats, but you supplied "//$NON-NLS-1$
            + format);
  }
