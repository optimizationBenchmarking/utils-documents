...
public final class IEEEtranFontPalette extends FontPalette {
  ...
  private static final class __IEEETranDefaultFontPaletteBuilder
    ...
    protected final IEEEtranFontPalette createPalette(final FontStyle def,
        final FontStyle emph, final FontStyle code,
  ...
  private static final class __IEEETranDefaultFontPaletteLoader {
    ...
    static {
      ...
      try (final __IEEETranDefaultFontPaletteBuilder cspb = //
      new __IEEETranDefaultFontPaletteBuilder()) {
        FontPaletteXMLInput.getInstance().use()
            .setLogger(Configuration.getGlobalLogger())
            .setDestination(cspb)
            .addResource(IEEEtranFontPalette.class, "IEEEtran.fontPalette") //$NON-NLS-1$
            .create().call();
        pal = cspb.getResult();
