...
public class ComplexText extends PlainText implements IComplexText {
  ...
  public synchronized final BibliographyBuilder cite(
    ...
    return bb.subBibliography(
        new _BibliographyConsumer(citationMode, textCase, sequenceMode));
  }
  ...
  private final class _BibliographyConsumer
      implements IBibliographyConsumer {
