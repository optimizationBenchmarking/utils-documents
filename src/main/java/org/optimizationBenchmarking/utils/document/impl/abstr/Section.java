...
public class Section extends ComplexObject implements ISection {
  ...
  private static final int STATE_TITLE_BEFORE_OPEN = (Section.STATE_TITLE_CREATED
      + 1);
  /** the state in the header */
  private static final int STATE_TITLE_OPENED = (Section.STATE_TITLE_BEFORE_OPEN
      + 1);
  /** the state after the header */
  private static final int STATE_TITLE_CLOSED = (Section.STATE_TITLE_OPENED
      + 1);
  /** the state when the body has been created */
  private static final int STATE_BODY_CREATED = (Section.STATE_TITLE_CLOSED
      + 1);
  /** the state before the body */
  private static final int STATE_BODY_BEFORE_OPEN = (Section.STATE_BODY_CREATED
      + 1);
  /** the state in the body */
  private static final int STATE_BODY_OPENED = (Section.STATE_BODY_BEFORE_OPEN
      + 1);
  /** the state after the body */
  private static final int STATE_BODY_CLOSED = (Section.STATE_BODY_OPENED
      + 1);
  /** the state names */
