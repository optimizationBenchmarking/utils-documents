 ...
 */
public abstract class BasicFigure extends ComplexObject
    implements IFigure {
  ...
  private static final int STATE_CAPTION_BEFORE_OPEN = (BasicFigure.STATE_CAPTION_CREATED
      + 1);
  /** the state in the caption */
  private static final int STATE_CAPTION_OPENED = (BasicFigure.STATE_CAPTION_BEFORE_OPEN
      + 1);
  /** the state after the caption */
  private static final int STATE_CAPTION_CLOSED = (BasicFigure.STATE_CAPTION_OPENED
      + 1);

  /** the state when the graphic has been created */
  private static final int STATE_GRAPHIC_CREATED = (BasicFigure.STATE_CAPTION_CLOSED
      + 1);
  /** the state after the graphic */
  private static final int STATE_GRAPHIC_CLOSED = (BasicFigure.STATE_GRAPHIC_CREATED
      + 1);
  ...
  protected synchronized final void onClose() {
    ...
    try {
      this.onFigureClose(
          ((this.m_figureSize != null) ? this.m_figureSize
  ...
  private final Graphic __graphic() {
    ...
    this.m_doc.m_styles.initializeWithDefaults(g);
  ...
  public synchronized final ILineChart2D lineChart2D() {
    ...
    g = this.__graphic();
    return new _DelegatingLineChart2D(g,
        this.m_doc.createChart(g).lineChart2D());
  }
  ...
  public synchronized final IPieChart pieChart() {
    ...
    g = this.__graphic();
    return new _DelegatingPieChart(g,
        this.m_doc.createChart(g).pieChart());
  }
