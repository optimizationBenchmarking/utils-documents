...
public class XHTML10Configuration extends DocumentConfiguration {
  ...
  public XHTML10Configuration(final XHTML10ConfigurationBuilder builder) {
    ...
    XHTML10Configuration
        ._checkScreenSize(this.m_size = builder.getScreenSize());
    XHTML10Configuration
        ._checkFontPalette(this.m_fonts = builder.getFontPalette());
  }
   ...
   *          the font palette
   */
  static final void _checkFontPalette(final IFontPalette fonts) {
    if (fonts == null) {
  ...
  public boolean equals(final Object o) {
    ...
    if (o instanceof XHTML10Configuration) {
      if (super.equals(o)) {
        ...
        return (Compare.equals(this.m_fonts, config.m_fonts) && //
            Compare.equals(this.m_size, config.m_size));
      }
    } else {
      if (o instanceof XHTML10ConfigurationBuilder) {
        if (super.equals(o)) {
          builder = ((XHTML10ConfigurationBuilder) o);
          return (Compare.equals(this.m_fonts, builder.getFontPalette()) && //
              Compare.equals(this.m_size, builder.getScreenSize()));
        }
      }
    }
   ...
   *          the text out
   */
  static final void _font(final IFontStyle style,
