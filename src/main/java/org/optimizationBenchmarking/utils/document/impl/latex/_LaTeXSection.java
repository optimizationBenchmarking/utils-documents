...
final class _LaTeXSection extends Section {
  ...
  static {
    ...
    _LaTeXSection.SECTIONS[ELaTeXSection.SUBSECTION
        .ordinal()] = new char[] { '\\', 's', 'u', 'b', 's', 'e', 'c', 't',
            'i', 'o', 'n', '{' };

    _LaTeXSection.SECTIONS[ELaTeXSection.SUBSUBSECTION
        .ordinal()] = new char[] { '\\', 's', 'u', 'b', 's', 'u', 'b', 's',
            'e', 'c', 't', 'i', 'o', 'n', '{' };

    _LaTeXSection.SECTIONS[ELaTeXSection.PARAGRAPH
        .ordinal()] = new char[] { '\\', 'p', 'a', 'r', 'a', 'g', 'r', 'a',
            'p', 'h', '{' };

    _LaTeXSection.SECTIONS[ELaTeXSection.SUBPARAGRAPH
        .ordinal()] = new char[] { '\\', 's', 'u', 'b', 'p', 'a', 'r', 'a',
            'g', 'r', 'a', 'p', 'h', '{' };
  }
