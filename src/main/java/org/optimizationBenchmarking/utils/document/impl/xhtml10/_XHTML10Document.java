...
final class _XHTML10Document extends Document {
  ...
  private static final char[] XML_HEADER_BEGIN = { '<', '?', 'x', 'm', 'l',
      ' ', 'v', 'e', 'r', 's', 'i', 'o', 'n', '=', '"', '1', '.', '0', '"',
      ' ', 'e', 'n', 'c', 'o', 'd', 'i', 'n', 'g', '=', '"' };
  ...
  private static final char[] DOC_TYPE = { '<', '!', 'D', 'O', 'C', 'T',
      'Y', 'P', 'E', ' ', 'h', 't', 'm', 'l', ' ', 'P', 'U', 'B', 'L', 'I',
      'C', ' ', '"', '-', '/', '/', 'W', '3', 'C', '/', '/', 'D', 'T', 'D',
      ' ', 'X', 'H', 'T', 'M', 'L', ' ', '1', '.', '0', ' ', 'S', 't', 'r',
      'i', 'c', 't', '/', '/', 'E', 'N', '"', ' ', '"', 'h', 't', 't', 'p',
      ':', '/', '/', 'w', 'w', 'w', '.', 'w', '3', '.', 'o', 'r', 'g', '/',
      'T', 'R', '/', 'x', 'h', 't', 'm', 'l', '1', '/', 'D', 'T', 'D', '/',
      'x', 'h', 't', 'm', 'l', '1', '-', 's', 't', 'r', 'i', 'c', 't', '.',
      'd', 't', 'd', '"', '>' };
  ...
  private static final char[] META_CHARSET_BEGIN = { '<', 'm', 'e', 't',
      ...
      'c', 'o', 'n', 't', 'e', 'n', 't', '=', '"', 'a', 'p', 'p', 'l', 'i',
      'c', 'a', 't', 'i', 'o', 'n', '/', 'x', 'h', 't', 'm', 'l', '+', 'x',
      'm', 'l', ';', ' ', 'c', 'h', 'a', 'r', 's', 'e', 't', '=' };

  /** the meta style type */
  private static final char[] META_STYLE_TYPE = { '<', 'm', 'e', 't', 'a',
      ' ', 'h', 't', 't', 'p', '-', 'e', 'q', 'u', 'i', 'v', '=', '"', 'c',
      'o', 'n', 't', 'e', 'n', 't', '-', 's', 't', 'y', 'l', 'e', '-', 't',
      'y', 'p', 'e', '"', ' ', 'c', 'o', 'n', 't', 'e', 'n', 't', '=', '"',
      't', 'e', 'x', 't', '/', 'c', 's', 's', '"', ' ', '/', '>' };

  /** the default css link */
  private static final char[] DEFAULT_CSS_LINK = { '<', 'l', 'i', 'n', 'k',
      ' ', 'r', 'e', 'l', '=', '"', 's', 't', 'y', 'l', 'e', 's', 'h', 'e',
      'e', 't', '"', ' ', 'm', 'e', 'd', 'i', 'a', '=', '"', 'a', 'l', 'l',
      '"', ' ', 'h', 'r', 'e', 'f', '=', '"' };
  /** the print css link */
  ...
  private static final char[] FONT_SIZE = { 'f', 'o', 'n', 't', '-', 's',
      'i', 'z', 'e', ':' };
  /** the font family */
  private static final char[] FONT_FAMILY = { 'f', 'o', 'n', 't', '-', 'f',
      'a', 'm', 'i', 'l', 'y', ':' };
  /** the font variant */
  private static final char[] FONT_VARIANT = { 'f', 'o', 'n', 't', '-',
      'v', 'a', 'r', 'i', 'a', 'n', 't', ':', 'n', 'o', 'r', 'm', 'a', 'l',
      ';' };
  /** the font transform */
  ...
  protected void postProcess(final Set<IStyle> usedStyles,
    ...
    try {
      for (final String name : new String[] { _XHTML10Document.CSS_DEFAULT,
          _XHTML10Document.CSS_PRINT }) {
   ...
   *           if i/o fails
   */
  private static final void __writeFont(final IFontStyle fs,
  ...
  private final void __createStyles(final BufferedWriter bw,
    ...
    final IFontStyle def;
    final Styles ss;
    IFontStyle fs, code, em;
