...
final class _XHTML10Bibliography {
  ...
  private static final char[] SPAN_IN_COLLECTION = { '<', 's', 'p', 'a',
      'n', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'i', 'n', 'C', 'o', 'l',
      'l', 'e', 'c', 't', 'i', 'o', 'n', '"', '>' };
  /** the in proceedings */
  private static final char[] SPAN_IN_PROCEEDINGS = { '<', 's', 'p', 'a',
      'n', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'i', 'n', 'P', 'r', 'o',
      'c', 'e', 'e', 'd', 'i', 'n', 'g', 's', '"', '>' };
  /** the proceedings */
  private static final char[] SPAN_PROCEEDINGS = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'p', 'r', 'o', 'c', 'e', 'e',
      'd', 'i', 'n', 'g', 's', '"', '>' };
  /** the tech report */
  private static final char[] SPAN_TECH_REPORT = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 't', 'e', 'c', 'h', 'R', 'e',
      'p', 'o', 'r', 't', '"', '>' };
  /** the thesis */
  private static final char[] SPAN_THESIS = { '<', 's', 'p', 'a', 'n', ' ',
      'c', 'l', 'a', 's', 's', '=', '"', 't', 'h', 'e', 's', 'i', 's', '"',
      '>' };
  /** the website */
  private static final char[] SPAN_WEBSITE = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'w', 'e', 'b', 's', 'i', 't',
      'e', '"', '>' };
  /** the authors */
  private static final char[] SPAN_AUTHORS = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'a', 'u', 't', 'h', 'o', 'r',
      's', '"', '>' };
  /** the author */
  ...
  private static final char[] SPAN_CHAPTER = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'c', 'h', 'a', 'p', 't', 'e',
      'r', '"', '>', 'c', 'h', 'a', 'p', 't', 'e', 'r', '&', 'n', 'b', 's',
      'p', ';' };
  /** the journal volume */
  private static final char[] SPAN_JOURNAL_VOLUME = { '<', 's', 'p', 'a',
      'n', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'j', 'v', 'o', 'l', 'u',
      'm', 'e', '"', '>' };
  /** the issue */
  ...
  private static final char[] SPAN_LINK = { '<', 's', 'p', 'a', 'n', ' ',
      ...
      '<', 'a', ' ', 'h', 'r', 'e', 'f', '=', '"' };
  /** the thesis type */
  private static final char[] SPAN_THESIS_TYPE = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 't', 't', 'y', 'p', 'e', '"',
      '>' };

  /** the institute span */
  private static final char[] SPAN_INSTITUTE = { '<', 's', 'p', 'a', 'n',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'i', 'n', 's', 't', 'i', 't',
      'u', 't', 'e', '"', '>' };
   ...
   */
  static final void _appendRecord(final BibRecord r, final ITextOutput out,
    ...
    if (r instanceof BibInCollection) {
      _XHTML10Bibliography.__appendInCollection(((BibInCollection) r), out,
          raw);
      return;
    }
    ...
    if (b == null) {
      ...
      if (year1 == year2) {
        ...
        _XHTML10Bibliography.__fullDate(year1, quarter1, month1, day1, wco,
            raw);
        raw.append(_XHTML10Bibliography.M_DASH);
        _XHTML10Bibliography.__fullDate(year2, quarter2, month2, day2, wco,
            raw);
      }
  ...
  private static final void __appendWebsite(final BibWebsite ref,
    ...
    needsComma = _XHTML10Bibliography.__appendOrganization(
        _XHTML10Bibliography.SPAN_PUBLISHER, true, ref.getPublisher(), wco,
        raw);
   ...
   *          the raw output
   */
  private static final void __appendInCollection(final BibInCollection ref,
      final ITextOutput wco, final ITextOutput raw) {
    boolean d;
    String sp, ep;
  ...
  private static final void __appendThesis(final BibThesis ref,
    ...
    needsComma = _XHTML10Bibliography.__appendOrganization(
        _XHTML10Bibliography.SPAN_SCHOOL, needsComma, ref.getSchool(), wco,
        raw);
