...
public abstract class DocumentBuilder
    extends DocumentProducerJobBuilder<Document, DocumentBuilder>
    implements IDocumentBuilder, ITextable {
  ...
  /** {@inheritDoc} */
  @Override
  public final DocumentBuilder setColorModel(
  ...
  /** {@inheritDoc} */
  @Override
  public final DocumentBuilder setGraphicDriver(
    ...
    if (((logger = this.getLogger()) != null)
      ...
      logger.fine(//
          "Begin creation of document '" + //$NON-NLS-1$
              this.getMainDocumentNameSuggestion() + "' in folder '" //$NON-NLS-1$
              + this.getBasePath() + "' with graphic driver " + //$NON-NLS-1$
