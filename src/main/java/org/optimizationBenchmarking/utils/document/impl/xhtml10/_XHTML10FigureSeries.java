...
final class _XHTML10FigureSeries extends FigureSeries {
  ...
  private static final char[] SUBFIGURE_TABLE_BEGIN = { '<', 't', 'a', 'b',
      'l', 'e', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 's', 'u', 'b', 'f',
      'i', 'g', 'u', 'r', 'e', '"', '>' };

  /** the start of the float tr caption */
  private static final char[] SUBFIGURE_TR_CAPTION_BEGIN = { '<', 't', 'r',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 's', 'u', 'b', 'f', 'i', 'g',
      'u', 'r', 'e', 'C', 'a', 'p', 't', 'i', 'o', 'n', '"', '>' };
  ...
  private static final char[] SUBFIGURE_TD_CAPTION_SPAN_BEGIN = { '<', 't',
      'd', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 's', 'u', 'b', 'f', 'i',
      'g', 'u', 'r', 'e', 'C', 'a', 'p', 't', 'i', 'o', 'n', '"', '>', '<',
      's', 'p', 'a', 'n', ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'c', 'a',
      'p', 't', 'i', 'o', 'n', 'T', 'i', 't', 'l', 'e', '"', '>', 'F', 'i',
      'g', '.', '&', 'n', 'b', 's', 'p', ';' };
  /** the start of the float td */
  private static final char[] SUBFIGURE_TD_CAPTION_EMPTY = { '<', 't', 'd',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 's', 'u', 'b', 'f', 'i', 'g',
      'u', 'r', 'e', 'C', 'a', 'p', 't', 'i', 'o', 'n', '"', '/', '>' };
