...
public class DocumentConfiguration extends GraphicConfiguration {
  ...
  protected DocumentConfiguration(
    ...
    DocumentConfiguration
        ._checkChartDriver(this.m_chartDriver = builder.getChartDriver());
  ...
  public boolean equals(final Object o) {
    ...
    if (o instanceof DocumentConfiguration) {
      if (super.equals(o)) {
        ...
        return (Compare.equals(this.m_chartDriver, config.m_chartDriver) && //
            Compare.equals(this.m_documentDriver,
                config.m_documentDriver));
      }
    } else {
      if (o instanceof DocumentConfigurationBuilder) {
        if (super.equals(o)) {
          builder = ((DocumentConfigurationBuilder) o);
          return (Compare.equals(this.m_chartDriver,
              builder.getChartDriver()) && //
              Compare.equals(this.m_documentDriver,
                  builder.getDocumentDriver()));
        }
      }
    }
