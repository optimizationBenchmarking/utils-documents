...
public class DocumentConfigurationBuilder
    extends GraphicConfigurationBuilder {
  ...
  protected void configureWithoutDriver(final Configuration config) {
    ...
    newDriver = config.get(DocumentConfigurationBuilder.PARAM_CHART_DRIVER,
  ...
  public boolean equals(final Object o) {
    ...
    if (o instanceof DocumentConfiguration) {
      if (super.equals(o)) {
        ...
        return (Compare.equals(this.m_chartDriver, config.getChartDriver())//
            && Compare.equals(this.m_documentDriver,
                config.getDocumentDriver()));
      }
    } else {
      if (o instanceof DocumentConfigurationBuilder) {
        if (super.equals(o)) {
          builder = ((DocumentConfigurationBuilder) o);
          return (Compare.equals(this.m_chartDriver, builder.m_chartDriver)//
              && Compare.equals(this.m_documentDriver,
                  builder.m_documentDriver));
        }
      }
    }
  ...
  public int hashCode() {
    return HashUtils.combineHashes(super.hashCode(),
        HashUtils.combineHashes(HashUtils.hashCode(this.m_chartDriver),
