...
final class _XHTML10DocumentHeader extends DocumentHeader {
  /** the title start */
  private static final char[] TITLE_BEGIN = { '<', 't', 'i', 't', 'l', 'e',
      '>' };
  /** the title end */
  ...
  private static final char[] META_DESC = { '<', 'm', 'e', 't', 'a', ' ',
      'n', 'a', 'm', 'e', '=', '"', 'D', 'C', '.', 'D', 'e', 's', 'c', 'r',
      'i', 'p', 't', 'i', 'o', 'n', '"', ' ', 'c', 'o', 'n', 't', 'e', 'n',
      't', '=', '"', };
  /** the meta title data */
  private static final char[] META_TITLE = { '<', 'm', 'e', 't', 'a', ' ',
      'n', 'a', 'm', 'e', '=', '"', 'D', 'C', '.', 'T', 'i', 't', 'l', 'e',
      '"', ' ', 'c', 'o', 'n', 't', 'e', 'n', 't', '=', '"' };
  ...
  private static final char[] ABSTRACT_DIV_BEGIN = { '<', 'd', 'i', 'v',
      ' ', 'c', 'l', 'a', 's', 's', '=', '"', 'a', 'b', 's', 't', 'r', 'a',
      'c', 't', '"', '>', '<', 's', 'p', 'a', 'n', ' ', 'c', 'l', 'a', 's',
      's', '=', '"', 'a', 'b', 's', 't', 'r', 'a', 'c', 't', 'T', 'i', 't',
      'l', 'e', '"', '>', 'A', 'b', 's', 't', 'r', 'a', 'c', 't', '.', '<',
      '/', 's', 'p', 'a', 'n', '>', '&', 'n', 'b', 's', 'p', ';' };
  ...
  protected final boolean mustChildBeBuffered(
    ...
    return ((child instanceof DocumentTitle)
        || (child instanceof DocumentSummary));
  }
