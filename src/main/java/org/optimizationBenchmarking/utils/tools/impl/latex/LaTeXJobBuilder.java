 ...
 */
public class LaTeXJobBuilder
    extends ConfigurableToolJobBuilder<LaTeXJob, LaTeXJobBuilder>
    implements IFileProducerJobBuilder {
   ...
   * @return this builder
   */
  public synchronized LaTeXJobBuilder requireFileType(
