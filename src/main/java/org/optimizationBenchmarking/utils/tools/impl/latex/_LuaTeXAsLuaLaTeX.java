...
final class _LuaTeXAsLuaLaTeX extends _LaTeXUsedAsToolBase {
  ...
  static final class _LuaTeXPathLoader {
    ...
    static final Path PATH = PathUtils.findFirstInPath(
        new AndPredicate<>(new FileNamePredicate(true, "luatex" //$NON-NLS-1$
  ...
  /** the description */
  private static final class __LuaTeXAsLuaLaTeXDesc
